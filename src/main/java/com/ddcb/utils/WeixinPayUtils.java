...
public class WeixinPayUtils {
	...
	private static String appid = "wxf139053a88924f58";
	private static String appsecret = "575307db56443f25501a097f8679fd1e";
	private static String partner = "1488074302";
	// 这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "zaq12wsxcde34rfvbgt56yhnmju78ki9";
	// openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "";
	// 微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.udiyclub.com/weixinUserCoursePayResult"; // Key
