			...
			<div class="contain">
				...
				<nav class="PC-nav">
					<ul>
						...
						<li class="news"><a href="mentor.html">留学服务</a>
					</li>
						...
						<li class="search"><a href="document.html">资料下载</a></li>
				...
				<nav class="mobile-nav">
					...
					<ul class="nav-list">
						...
						<li class="fa" data-id="fa"><a href="/courses/views/courses.html">在线课程</a></li>
					</ul>
