    ...
    var i = t(4)
      ...
      , s = {
            ...
            $.ajax({
                ...
                success: function(n) {
                    if ("200" == n.code) {
                        ...
                        var l = template.compile(o)
                          , c = l({});
                        $(".login-container").append(c),
        ...
        parseQueryString: function(e) {
            for (var n, t = e.split("?")[1], i = t.split("&"), a = {}, o = 0; o < i.length; o++)
                n = i[o].split("="),
                a[n[0]] = n[1];
            return a
        },
        showLogin: function() {
            var e = template.compile(a)
              , n = e({});
      ...
      , l = {
        ...
        bind: function() {
            var e, n, t = this, i = $(".login-phone"), a = $(".verify-code"), o = $(".send-verify-code"), s = $(".voice-code"), l = $(".voice-code-tips"), c = $(".voice-code-tips label"), r = $(".voice-code span"), d = $(".login-submit"), u = $(".phone-tips"), p = ($(".login-mask"),
            $(".login-dialog")), h = $(".login-container input").val(), f = 60, v = 60, m = /^1[3|4|5|7|8|][0-9]{9}$/;
            r.removeClass("voice-able").addClass("voice-disable"),
            o.removeClass("btn-able").addClass("btn-disable"),
            p.on("blur", ".input", function() {
                ...
                if (e.hasClass("login-phone")) {
                    ...
                    o.removeClass("btn-disable").addClass("btn-able"),
            ...
            o.off().on("click", function() {
                ...
                return !n.hasClass("btn-disable") && ("true" != n.attr("send") && void $.ajax({
                    ...
                    success: function(n) {
                        ...
                        o.val(f + "s").css("background", "#ccc"),
                        o.attr("send", !0).removeClass("btn-able").addClass("btn-disable"),
                        e = setInterval(function() {
                            f--,
                            f > 0 ? (o.val(f + "s").css("background", "#ccc"),
                            o.attr("send", !0).removeClass("btn-able").addClass("btn-disable")) : (o.val("发送验证码").css("background", "#5b86db"),
                            o.attr("send", !1).removeClass("btn-disable").addClass("btn-able"),
                            f = 60,
                            clearInterval(e))
...
, function(e, n, t) {
    var i = t(8)
      ...
      , o = {
        ...
        bind: function() {
            var e, n, t = this, i = $(".login-phone"), o = $(".verify-code"), s = $(".send-verify-code"), l = $(".voice-code-tips"), c = $(".voice-code-tips label"), r = $(".voice-code"), d = $(".voice-code span"), u = $(".login-submit"), p = $(".login-regist-card .tips"), h = ($(".login-mask"),
            $(".mobile-dialog")), f = $(".login-container input").val(), v = /^1[3|4|5|7|8|][0-9]{9}$/, m = 60, g = 60;
            d.removeClass("voice-able").addClass("voice-disable"),
            s.removeClass("btn-able").addClass("btn-disable"),
            h.on("blur", ".input", function() {
                var e = $(this);
                if (e.hasClass("login-phone")) {
                    if (!v.test($.trim(i.val())))
            ...
            u.off().on("click", function() {
                return v.test($.trim(i.val())) ? "" == $.trim(o.val()) || $.trim(o.val()).length > 4 ? (p.html("请填写验证码"),
                t.clearTipsHtml(p),
                !1) : (p.html(""),
    ...
    var i = t(10)
      , a = {
        ...
        getFootPartner: function() {
            $.get("/api/website/partners/", function(e) {
                if ("200" == e.code) {
...
, , , , , , function(e, n) {
    var t = {
        ...
        isPhoneWechat: function(e, n, t, i) {
            for (var a = navigator.userAgent, o = !1, s = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], l = 0; l < s.length; l++) {
                if (a.indexOf(s[l]) > 0) {
                    o = !0;
                    break
                }
        ...
        getWx: function(e, n, t, i) {
            ...
            $.ajax({
                ...
                data: o,
                success: function(o) {
                    a.callBack(o.data, e, n, t, i)
                }
            })
        },
        callBack: function(e, n, t, i, a) {
        ...
        dealTime: function(e) {
            var n = Date.parse(new Date)
              ...
              , a = e.split(" ")[0].replace(/-/g, "/").split("/")[0]
              , o = e.split(" ")[0].replace(/-/g, "/").split("/")[1]
              , s = e.split(" ")[0].replace(/-/g, "/").split("/")[2]
              , l = (e.split(" ")[1].split(":")[0],
            e.split(" ")[1].split(":")[1],
            (n - i) / 1e3);
            return l < 60 ? e = "刚刚" : 60 <= l && l < 3600 ? e = Math.round(l / 60) + "分钟前" : 3600 <= l && l < 86400 ? e = Math.round(l / 3600) + "小时前" : 86400 <= l && (e = a < t ? a + "年" + o + "月" + s + "日 " : o + "月" + s + "日 "),
            e
        },
      ...
      , o = {
        ...
        bindEvent: function() {
            ...
            $(".my-course").click(function() {
                e.isLoginStatus ? window.location.href = "/course/buy/" : e.isPhone() ? i.showLogin() : a.showLogin()
            })
        },
        isLogin: function() {
            var e = this;
...
, function(e, n, t) {
    var i = t(17)
      ...
      , o = {
        wxinfo: {
            img: "http://static-image.xfz.cn/share_logo.png",
            title: "小饭桌夜校在线课堂系列课程，系统学习相关知识，助你进阶成长！",
            desc: "小饭桌夜校在线课堂系列课程，系统学习相关知识，助你进阶成长！"
        },
        init: function() {
            a.init(),
            i.isPhoneWechat(this.wxinfo.desc, this.wxinfo.desc, this.wxinfo.img)
        }
    };
    e.exports = o
}
