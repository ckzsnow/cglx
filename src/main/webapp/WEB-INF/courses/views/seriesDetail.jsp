...
<body device="pc">
	<header class="header">
		...
		<div class="contain">
			...
			<nav class="PC-nav">
				<ul>
					<li class="news" data-id="news"><a href="homepage.html">留学专栏</a>
					</li>
					<li class="active"><a href="courses.html">在线课程</a></li>
					<li class="activity" data-id="activity"><a
						href="success.html">成功案例</a></li>
					<li class="gift" data-id="gift"><a href="about.html">关于我们</a>
					</li>
					<li class="ventureservice" data-id="ventureservice"><a
						href="report.html">社员风采</a></li>
					<li class="search" data-id="search"><a href="search.html">搜索</a>
					</li>
				</ul>
			</nav>
	...
	<div class="wrapper" id="wrapper">
		...
		<nav class="video-nav">
			<div class="container">
				...
				<ul>
					<li><a href="courses.html">最新课程</a></li>
					<li><a href="essay.html">文书写作</a></li>
					<li><a href="major.html">院校专业</a></li>
					<li><a href="case.html">成功案例</a></li>
					<li><a href="experience.html">留学体验</a></li>
					<li class="active"><a href="series.html">系列课</a></li>
				</ul>
	...
	$(document).on('click', function() {
		...
		$.post('/course/getSeriesSubCourseById', {id : id}, function(data) {
			for(var index in data) {
				$('.series-course-all').append('<div class="series-every-course"><a href="detail.html?id='+data[index].id+'" target="_blank">'
		...
		$.post('/course/getNavRecommendCourse', function(data) {
			for(var index in data) {
				if(data[index].is_series == 1) {
					...
					$('#big').append('<div class="recommend-big"><a href="seriesDetail.html?id='+data[index].id+'" target="_blank">' 
					...
					$('#recommend-big').append('<div class="item"><a href="seriesDetail.html?id='+data[index].id+'"><div class="photo">'
							+ '<img	src="/cglx/files/imgs/'+data[index].snapshot+'"></div><div class="info"><span class="left">'
							+ '共'+data[index].sub_count+'节课</span> <span class="right"><span class="spend-price">¥'+data[index].total+'</span>'
							+ '(省'+data[index].discount+'元) </span></div></a></div>');						
				} else {
					
					$('#small').append('<div class="recommend-every-course"><a href="detail.html?id='+data[index].id+'" target="_blank">'
					...
					$('#recommend-small').append('<div class="every-course"><a href="detail.html?id='+data[index].id+'"><div class="info-left-recommond">'
